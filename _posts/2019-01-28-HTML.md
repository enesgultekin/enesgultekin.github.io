...
<p>Fotoğrafta görüldüğü gibi boşluk ve satır atlama gibi durumları dikkate almadı. Eğer &lt;p&gt; etiketini kullanarak satır atlamak istersek, satır atlamak istediğimiz kelimenin sonuna &lt;br&gt; etiketi koyarak satır atlayabiliriz.<br>
...
<strong>&lt;pre&gt; Etiketi İle Paragraf</strong><br>
<img src="/resimler/html/paragraf/pre2.JPG" alt="pre içerik"><br>
<b>Görsel</b><br>
<img src="/resimler/html/paragraf/pre.JPG" alt="pre görsel"><br>
...
<strong>&lt;b&gt;Etiketi</strong> metni bold yani kalın olarak yazılmasına yarar. Açılıp kapanan bir etikettir.<br>
<b>İçerik</b><br>
<img src="/resimler/html/format/b1.JPG" alt="b içerik"><br>
<b>Görsel</b>
<img src="/resimler/html/format/b2.JPG" alt="b görsel"><br>
<strong>&lt;u&gt; Etiketi</strong> metni altını çizili bir biçimde göstermeye yarar. Açılıp kapanan bir etikettir.<br>
<b>İçerik</b><br>
<img src="/resimler/html/format/u1.JPG" alt="u içerik"><br>
<b>Görsel</b><br>
<img src="/resimler/html/format/u2.JPG" alt="u görsel"><br>
<strong>&lt;del&gt; Etiketi </strong>metnin üstünü çizerek göstermek için yani silinmiş olduğunu belirtmek için kullanılır.Örnek olarak alışveriş sitelerinde indirimden önceki fiyatın üstü çizilmiş olarak gösterilebilir. Açılıp kapanan bir etikettir.<br>
<b>İçerik</b><br>
<img src="/resimler/html/format/del1.JPG" alt="del içerik"><br>
<b>Görsel</b><br>
<img src="/resimler/html/format/del2.JPG" alt="del görsel"><br>

<strong>&lt;i&gt; Etiketi</strong> metni italik olarak yani eğik olarak göstermek için kullanılır. Açılıp kapanan bir etikettir.<br>
<b>İçerik</b><br>
<img src="/resimler/html/format/i1.JPG" alt="i içerik"><br>
<b>Görsel</b><br>
<img src="/resimler/html/format/i2.JPG" alt="i görsel"><br>

<strong>&lt;sub&gt; Etiketi</strong> metni normal hizanın altında göstermek için kullanılır. Açılıp kapanan bir etikettir.<br>
<b>İçerik</b><br>
<img src="/resimler/html/format/sub1.JPG" alt="sub içerik"><br>
<b>Görsel</b><br>
<img src="/resimler/html/format/sub2.JPG" alt="sub görsel"><br>
<strong>&lt;sup&gt; Etiketi </strong> metni normal yazı hizasının üstünde göstermek için kullanılır. Açılıp kapanan bir etikettir.<br>
