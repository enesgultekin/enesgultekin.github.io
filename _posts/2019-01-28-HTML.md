...
<b>İçerik</b><br><br>
<img src="/resimler/html/görütü/img1.JPG" alt="img içerik"><br><br>
Buradaki src kısmındaki “resim.jpg”  html dosyasının bulunduğu dizinde olduğu için sadece isim ve uzantı bildirmemiz yeterli oldu. Eğer resim dosyası farklı bir yerde iste örnek olarak ”/resimler/resim.jpg” gibi adres bilgisi verilmelidir.HTML dosyasının kayıtlı olduğu dizini her zaman başlangıç dizini olarak belirler.Ayrıca src kısmına internet üzerinden bulduğumuz bir resmin bağlantı adresini kopyalayıp yapıştırmak da aynı biçimde görüntü sağlar ama bağlantının kopyalandığı siteden görselin kaldırılma veya değiştirilme ihtimaline karşı tavsiye edilmemektedir. Bağlantı adresinden kaldırılan resimler sizin siteniz içinde de görüntülenemez olacaktır. <br><br>
Görsel<br><br>
<img src="/resimler/html/görütü/img2.JPG" alt="img içerik"><br><br>


<strong>&lt;Picture&gt; Etiketi &lt;img&gt; etiketi ile birlikte kullanılır.Picture etiketi açılacak resmin mobil cihazların tarayıcılarında farklı, bilgisayar tarayıcılarında farklı boyutlarda açılmasını sağlar. Bu sayede telefon ya da tablet üzerinden bağlantı kuran kullanıcıların fotoğrafı daha hızlı görüntülemesine olanak sağlar. Açılıp kapanan bir etikettir.<br><br>
 İçerik<br><br>
  <img src="/resimler/html/görütü/pic1.JPG" alt="pic içerik"><br><br>
  Görsel<br><br>
  <img src="/resimler/html/görütü/pic2.JPG" alt="pic görsel"><br><br>
...
İçerik<br><br>
  <img src="/resimler/html/görütü/map1.JPG" alt="map içerik"><br><br>
...
Shape parametresi ile seçilecek bölgenin hangi geometrik şekille olacağını belirledik.<br>
  ...
  Görsel<br><br>
    <img src="/resimler/html/görütü/map2.JPG" alt="map görsel"><br><br>
...
İçerik<br><br>
 <img src="/resimler/html/görütü/canvas1.JPG" alt="canvas içerik"><br><br>
 Görsel<br><br>
  <img src="/resimler/html/görütü/canvas2.JPG" alt="canvas görsel"><br><br>
  <strong>&lt;script&gt; Etiketi</strong> ile canvas üzerinde çizim yapacağımız bir JavaScript oluşturuyoruz.<br><br>
  İçerik<br><br>
    <img src="/resimler/html/görütü/cvs1.JPG" alt="canvas görsel"><br><br>
 Görsel<br><br<
   <img src="/resimler/html/görütü/cvs2.JPG" alt="canvas içerik"><br><br>
...
İçerik<br><br>
<img src="/resimler/html/görütü/svg1.JPG" alt="svg içerik"><br><br>
Görsel<br><br>
<img src="/resimler/html/görütü/svg2.JPG" alt="svg görsel"><br><br>

Svg Etiketinin Canvas etiketinden farklı şunlardır;<br>
<ul type="circle">
...
<center><h1>HTML Programlama Etiketleri</h1></center>
...
<center><h1>HTML Form Ve Input Etiketleri</h1></center>
...
Görsel<br><br>
<img src="/resimler/html/program/inputs2.JPG" alt="input görsel"><br><br>
...
<img src="/resimler/html/program/f1.JPG" alt="form içerik"><br><br>
Görsel<br><br>
<img src="/resimler/html/program/f2.JPG" alt="input görsel"><br><br>
