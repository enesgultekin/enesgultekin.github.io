...
<strong>Description</strong> : Sitenin içeriği hakkında bilgi vermek için kullanılır.<br><br>
<img src="/resimler/html/meta/description.jpg" alt="description"><br><br>
<strong>Author</strong> : Sitenin yazarının iletişim bilgisini göstermek için kullanılır.<br><br>
<img src="/resimler/html/meta/author.jpg" alt="author"><br><br>
<strong>Charset</strong> : Sayfanın hangi dilde kodlandığını belirtmek için kullanılır.<br><br>
<img src="/resimler/html/meta/charset.jpg" alt="charset"><br><br>
<strong>Keywords</strong>: Arama motoruna sayfanın içeriğini anahtar kelimeler halinde belirtmeye yarar.<br><br>
<img src="/resimler/html/meta/keywords.JPG" alt="keywords"><br><br>
<strong>Copyright</strong>: Sayfanın telif haklarını belirtmek için kullanılır.<br><br>
<img src="/resimler/html/meta/copyright.JPG" alt="copyright"><br><br>
<strong>Designer</strong>: Sayfanın tasarımcısını belirtmek için kullanılır<br><br>
<img src="/resimler/html/meta/designer.JPG" alt="designer"><br><br>
<strong>Distribution</strong>: Sitenin hitap ettiği ülke-bölge belirtmek için kullanılır.<br><br>
3 seçenek mevcuttur.<strong> Global , Local ve IU</strong>.<br><br>
<img src="/resimler/html/meta/distribution.JPG" alt="distribution"><br><br>
<strong>Expires</strong> : Sayfanın geçerlilik süresini belirtmek için kullanılır.<br><br>
<img src="/resimler/html/meta/expires.JPG" alt="expires"><br><br>
<strong>Generator</strong>: Sayfanın hangi program ismi ile oluşturulduğunu belirtmek için kullanılır<br><br>
<img src="/resimler/html/meta/generator.JPG" alt="generator"><br><br>
<strong>Content-Type</strong>: Web sayfasının içerik türünü ve karakter setini belirtmek için kullanılır.<br><br>
<img src="/resimler/html/meta/content-type.JPG" alt="content-type"><br><br>
<strong>Content-Language</strong>: Dil listesindeki değerlerden birini seçerek, web sayfasının içerik dilini belirmek için kullanılır.<br><br>
<img src="/resimler/html/meta/content-language.JPG" alt="content-language"><br><br>
<strong>Reply-to</strong>: Web sayfası hakkında e-posta adresi belirtmek için kullanılır.<br><br>
<img src="/resimler/html/meta/reply-to.JPG" alt="reply-to"><br><br>
<strong>Revisit-after</strong>: Web sayfasının kaç gün içinde güncellendiğini belirtmek için kullanılır.<br><br>
<img src="/resimler/html/meta/revisit-after.JPG" alt="revisit-after"><br><br>
<strong>Refresh</strong>: Web sayfasının belirlenen süre sonunda belirli bir URL adresine yönlendirir.URL girilmezse sadece belirlenen süre sonunda sayfayı yeniler.<br><br>
<img src="/resimler/html/meta/refresh.JPG" alt="refresh"><br><br>
<strong>Abstract</strong>: Web sayfasının kısa özetini belirtmek için kullanılır.<br><br>
